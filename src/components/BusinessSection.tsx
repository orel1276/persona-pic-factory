...
const BusinessSection = () => {
  ...
  return (
    <section id="business" className="py-20 md:py-24 px-6 bg-background/90 mt-16 md:mt-20" ref={sectionRef}>
      <div className="container mx-auto max-w-5xl">
        ...
        >
          <span className="inline-block py-1 px-3 rounded-full bg-white/10 backdrop-blur-sm text-white text-sm font-medium mb-5 md:mb-6">
            תפסיק להיות נעלם
          </span>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-10 items-center">
          <div 
            className={cn(
              ...
              isVisible ? "opacity-100 translate-y-0 md:translate-x-0" : "opacity-0 translate-y-10 md:translate-x-20"
            )}
          >
            <div className="bg-gradient-to-r from-primary/10 to-secondary/10 p-1 rounded-xl hover:from-primary/20 hover:to-secondary/20 transition-all duration-300 hover:-translate-y-1">
              <div className="bg-background/80 backdrop-blur-sm rounded-lg p-6 md:p-8">
                <h3 className="text-xl md:text-2xl font-bold mb-5 md:mb-6 text-sky-400">למוצרים שמשנים את המשחק</h3>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <span className="text-sky-400 flex-shrink-0 ml-3 mr-0">🏷️</span>
          ...
          >
            <div className="bg-gradient-to-r from-secondary/10 to-primary/10 p-1 rounded-xl hover:from-secondary/20 hover:to-primary/20 transition-all duration-300 hover:-translate-y-1">
              <div className="bg-background/80 backdrop-blur-sm rounded-lg p-6 md:p-8">
                <h3 className="text-xl md:text-2xl font-bold mb-5 md:mb-6 text-sky-400">לעסק שרוצה להוביל</h3>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <span className="text-sky-400 flex-shrink-0 ml-3 mr-0">🧑‍💼</span>
        ...
        <div 
          className={cn(
            "mt-10 md:mt-16 text-center transition-all duration-1000 delay-700 transform",
