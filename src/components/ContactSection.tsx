...
const ContactSection = () => {
  ...
  return (
    <section 
      id="contact" 
      className={`py-12 md:py-24 px-4 md:px-6 bg-[#05152a] transition-all duration-700 ${
    ...
    >
      <div className="container mx-auto max-w-4xl">
        <div className="text-center mb-8 md:mb-10">
          ...
          <p className="text-lg text-white/90 max-w-2xl mx-auto px-2 md:px-4">
            מעוניין בתדמית חדשה שתמשוך לקוחות? השאר פרטים ואחזור אליך בהקדם
          </p>
        </div>

        <div className="bg-slate-800/60 p-4 md:p-8 rounded-xl shadow-lg border border-slate-700/50 mx-2 md:mx-0">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <div className="flex flex-col justify-between mt-4 md:mt-0">
              <div>
                ...
                <p className="text-white/80 mb-5 md:mb-6 text-center md:text-right">
                ...
                <button 
                  ...
                  className="bg-[#25D366] hover:bg-[#1da851] w-full text-white font-medium py-4 px-5 rounded-lg shadow-md transition-all duration-300 text-base md:text-lg flex items-center justify-center gap-2 md:gap-3 hover:shadow-lg mb-5 md:mb-6 min-h-[48px]"
                >
