      ...
      <div className="container mx-auto max-w-7xl">
        ...
        {isMobile ? (
          <div className="mt-8 overflow-x-auto pb-6">
            <div className="flex space-x-4 px-2" style={{ direction: 'ltr' }}>
              <div className="bg-[#E5DDD5] rounded-2xl overflow-hidden shadow-xl min-w-[280px] max-w-[320px] flex-shrink-0">
