      ...
      >
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          ...
          <button 
            ...
            className="bg-[#25D366] hover:bg-[#00a859] text-white font-medium py-3 px-4 md:px-5 rounded-[30px] shadow-md transition-all duration-300 text-sm flex items-center gap-2 hover:scale-[1.03] hover:shadow-lg mr-5 hidden md:flex"
          >
