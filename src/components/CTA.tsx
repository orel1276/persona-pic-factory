  ...
  return (
    <section id="צור-קשר" className="py-16 md:py-24 px-6 bg-[#05152a] border-t border-white/10">
      <div className="container mx-auto max-w-5xl text-center">
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-8 md:p-10 mb-10">
        ...
        <div className="flex flex-col items-center space-y-6">
          <button
            ...
            className="bg-gradient-to-r from-fuchsia-600 to-pink-600 text-white font-bold py-5 px-12 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 text-xl md:text-2xl w-full md:w-auto max-w-md"
          >
